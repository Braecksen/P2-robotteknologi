...
%Solving for theta1 first value
...
% Første theta1 løsning alle theta 5
% Convert theta_5 to radians
theta_5rad = deg2rad(theta_5degrees);

% Calculate theta_6 using the corrected value of theta_5
...
%% all sols
Thetasoloution7 = [theta_1degrees, theta_2deg,  theta_3degrees, theta_4degrees ,theta_5degrees, theta_6degrees]
